...
echo "new 2*2"
./echo_avetime.sh "mpirun -map-by ppr:4:socket --bind-to core -n 4 -report-bindings bin/main_new"

echo "old 2*2"
./echo_avetime.sh "mpirun -map-by ppr:4:socket --bind-to core -n 4 -report-bindings bin/main_old"
...
echo "new 8*8"
./echo_avetime.sh "mpirun -map-by ppr:13:socket --bind-to core -n 64 -report-bindings bin/main_new"

echo "old 8*8"
./echo_avetime.sh "mpirun -map-by ppr:13:socket --bind-to core -n 64 -report-bindings bin/main_old"